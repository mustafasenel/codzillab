...
const UserCard = forwardRef<HTMLDivElement, UserCardProps>(function UserCard(
  ...
  return (
    <Card className="p-0 flex flex-col" ref={ref}>
      <div
        className="w-full h-24 bg-origin-content bg-cover bg-center rounded-t-xl bg-gradient-to-r from-slate-100 to-slate-300 dark:bg-gradient-to-r dark:from-slate-900 dark:to-slate-700"
        style={{
